...
#[tauri::command]
async fn example_feed() -> Result<Vec<FeedItem>, String> {
    let content = reqwest::get("https://example.com/feed.xml")
        .await
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, fun_fact, example_feed])
